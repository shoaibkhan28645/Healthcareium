          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-md md:text-lg mb-8 text-gray-300 max-w-md text-justify">
                Book certified physiotherapists for personalized rehabilitation
                sessions at your home. Regain strength, mobility, and comfort
                with expert care tailored to your needs.{" "}
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-4 pt-6 border-t border-white/20">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400">Customers Served</div>
                  </div>
                  <div className="text-center">
