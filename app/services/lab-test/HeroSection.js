      ...
      <section className="relative flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{ backgroundColor: "rgba(0, 29, 33, 0.6)" }}
          ></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-xl md:text-3xl lg:text-4xl xl:text-5xl  mb-4 text-purple-200 leading-tight font-medium">
                Convenient Lab Tests
                <br />
                <span className="text-white font-medium">at Your Home</span>
              </h1>

              <p className="text-md md:text-lg mb-8 text-gray-300 max-w-md text-justify">
                Book certified phlebotomists to collect your lab samples from
                the comfort of your home. Get accurate results from top labs in
                Pakistan.
              </p>
            ...
            <div className="relative lg:ml-8">
              ...
              <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-2xl">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Providing dignity, comfort, and professional medical support
                ...
                <div className="grid grid-cols-2 gap-4 pt-6 border-t border-white/20">
                  <div className="text-center">
                    <div className="text-2xl font-light text-purple-200 mb-1">
                      500+
                    </div>
                    <div className="text-xs text-gray-400">Families Served</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-light text-green-200 mb-1">
                      24/7
                    </div>
              ...
              {/* Decorative Elements */}
              {/* <div className="absolute -top-4 -right-4 w-8 h-8 bg-purple-400/30 rounded-full blur-sm"></div>
              <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-green-400/20 rounded-full blur-md"></div> */}
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="flex flex-col items-center gap-2 text-white/60"></div>
        </div>
      </section>
    </div>
  );
